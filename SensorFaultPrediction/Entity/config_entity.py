...
class DataTransformationConfig:
    ...
    '''
    def __init__(self,training_file_config:TrainingPipelineConfig):
        self.data_transformation_dir:str=os.path.join(training_file_config.artifact_dir_name,training_pipeline.DATA_TRANSFORMATION_DIR)
...
class ModelTrainingConfig:
    ...
    '''
    def __init__(self,training_file_config:TrainingPipelineConfig):
        self.model_trained_dir=os.path.join(training_file_config.artifact_dir_name,training_pipeline.MODEL_TRAINED_DIR)
...
class ModelEvaluationConfig:
    ...
    '''
    def __init__(self,training_file_config:TrainingPipelineConfig):
        self.model_evaluation_dir=os.path.join(training_file_config.artifact_dir_name,training_pipeline.MODEL_EVALUATION_DIR)
        self.report_file_path=os.path.join(self.model_evaluation_dir,training_pipeline.MODEL_EVALUATION_REPORT_NAME)
        self.changed_threshold=training_pipeline.MODEL_EVALUATION_CHANGED_THRESHOLD
...
class ModelPusherConfig:
    ...
    '''
    def __init__(self,training_file_config:TrainingPipelineConfig):
        self.model_pusher_dir=os.path.join(training_file_config.artifact_dir_name,training_pipeline.MODEL_PUSHER_DIR)
